...
export default function Contact() {
  ...
  if (loading) return <section className="section" id="contact"><div className="container"><Loading /></div></section>;
  if (error) return <section className="section" id="contact"><div className="container"><Err msg={error} /></div></section>;
  const me = (data || [])[0];
  if (!me) return null;

  const targetRecipient = 'md9611250@gmail.com';
  ...
  const handleFormSubmit = async (e) => {
    ...
    if (!trimmedName || !trimmedEmail || !trimmedSubject || !trimmedMessage) {
      setStatus({ state: 'error', message: 'Please fill in all fields (Name, Email, Subject/Purpose, Message).' });
      return;
    }
    ...
    try {
      ...
      setStatus({
        state: 'error',
        message: 'Could not send message. Please check your connection or try again.'
      });
    }
  };
                ...
                <div className="contact-item">
                  ...
                  <div>
                    ...
                    <div className="contact-item-value">
                      <a href={`mailto:${me.email}`} style={{ color: 'inherit', textDecoration: 'none' }}>{me.email}</a>
                    </div>
                  </div>
                </div>
              )}
              ...
              <div className="contact-social-buttons">
                {me.linkedId && (
                  <button
                    ...
                    onClick={(e) => { e.stopPropagation(); openExternalUrl(me.linkedId); }}
                ...
                {me.gitId && (
                  <button
                    ...
                    onClick={(e) => { e.stopPropagation(); openExternalUrl(me.gitId); }}
                ...
                {me.resume ? (
                  ...
                  >
                    ...
                    <div className="resume-btn-text">
                      ...
                      <div className="resume-btn-desc">Curriculum Vitae (PDF)</div>
                    </div>
                  ...
                  <button
                    ...
                    onClick={() => alert('Resume has not been uploaded yet. You can upload it via the Admin Panel!')}
                  ...
                  >
                    ...
                    <div className="resume-btn-text">
                      <div className="resume-btn-title">Download Resume</div>
                      <div className="resume-btn-desc">Upload in Admin Panel</div>
                    </div>
                    <span className="resume-btn-arrow" style={{ opacity: 0.5 }}>⏳</span>
                  </button>
                )}
              </div>
            </div>
          ...
          <div className="contact-form-card card fade-in">
            <div className="contact-form-header">
              ...
              <p className="contact-form-subtitle">
                Fill out the details below to send a message directly to <strong>{ownerName}</strong>.
              </p>
            </div>
            ...
            {status.state === 'success' ? (
              <div className="contact-form-success fade-in">
                ...
                <p className="success-desc">
                  Thank you! Your message has been sent directly to <strong>{ownerName}</strong>'s email inbox.
                </p>
                <button
                  type="button"
              ...
              <form className="contact-form" onSubmit={handleFormSubmit}>
                ...
                <button
                  ...
                  disabled={status.state === 'submitting'}
                  style={status.state === 'submitting' ? { opacity: 0.85, cursor: 'wait' } : undefined}
                >
